...
class Ver():
    ...
    def gestor_despesas(self):
        ...
        self.modificar_geometria(1000,500)
        ...
        self.frame1_et = tk.Entry(self.frame1,font=('Arial', 14), width=20)
        self.frame2_et = tk.Entry(self.frame2, font=('Arial', 14), width=22)
        self.frame2_et2 = tk.Entry(self.frame2,font=('Arial', 14), width=22)
        self.frame2_text = tk.Text(self.frame2,font=('Arial', 10), width=35, height=3)
        self.frame2_bt= tk.Button(self.frame2, text= 'Enter',font=('Arial', 14),width=5)
