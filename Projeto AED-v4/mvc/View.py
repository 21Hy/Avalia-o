...
class View:
    def __init__(self,master):
        ...
        self.clientes.insert_last(Cliente('Jorge','21','111111111'))
        self.clientes.insert_last(Cliente('Miguel','21','222222222'))
        self.clientes.insert_last(Cliente('Ronaldo','31','333333333'))
        self.login()
    ...
    def preencher_despesas(self):
        for i in range(len(self.controller.users)):
            if self.controller.users[i]['Nif'] == self.user_atual:
                for elmt in self.controller.users[i]['Userdata']:
                    self.despesas.insert_last(
                        Despesas( elmt['Categoria'], elmt['Descricao'], elmt['Valor'], elmt['Data'])
                    )
    ...
    def guardar(self):
        ...
        for elemento in self.controller.users:
            ...
            self.controller.data['Clientes'].append(elemento)
